...
from scripts.phase10_site_hooks import TensorSiteOrthogonalResidualInterchangeHook, parse_site_list
...
def evaluate_with_interchange_hook(model, prepared_item, anchor_layer, anchor_direction, layer, site, vector, donor_tensor, alpha, position_fraction, donor_norm_match):
...
def main():
    parser = argparse.ArgumentParser(description="Phase 10X: natural orthogonal-remainder interchange at the within-band corridor")
    ...
    parser.add_argument("--output-csv", type=str, default="logs/phase10/natural_orthogonal_interchange_summary.csv")
    ...
    print("Loading Genesis model for Phase 10X natural orthogonal-remainder interchange...")
    ...
    print("Running paired opposite-label natural orthogonal-remainder interchange evaluation...")
    detail_rows = []
