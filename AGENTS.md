...
3. Do not modify private/core research files outside this public folder.

## Public-Safe Documentation Rules
1. Do not publish private infrastructure names, machine nicknames, hostnames, or SSH commands.
2. Do not publish private absolute local paths from development machines.
3. Do not include internal-only run identifiers unless explicitly approved.
...
## Update Protocol (when syncing from private research)
...
4. Verify no private environment references remain.

## Quality Checklist Before Finalizing Changes
- [ ] All edits are inside this repository root.
- [ ] No private infra names, private hostnames, or private absolute paths appear.
