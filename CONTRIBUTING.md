...
Thanks for your interest in Spectral Microscope.

## What this public repository is for
- Public inline telemetry library (`src/spectral_microscope/`).
...
2. Include environment details and expected vs observed behavior.
